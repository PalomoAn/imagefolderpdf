...
def convert_images_to_pdf(directory_path):
    ...
    if image_files:
        ...
        with open(f"{folder_name}.pdf", "wb") as file:
            file.write(pdf_bytes)
            
        print(f"PDF created: {folder_name}.pdf")
    else:
        print(f"No JPEG or PNG files found in the folder: {folder_name}")
...
main_directory_path = "C:\\Users\\PC\\Franken Fran"
